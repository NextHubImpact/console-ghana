...
const Navbar = ({}) => {
  ...
  return (
    <div className={colorChange ? 'bg-black flex justify-between p-2 items-center sticky top- z-10 w-full ' : 'bg-[#262261]  flex justify-between p-2 items-center sticky z-10 top-  w-full '}>

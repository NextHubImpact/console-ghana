...
const Navbar = ({}) => {
  ...
  return (
    <div className={colorChange ? 'bg-black flex justify-between p- items-center top-0 fixed w-full ' : 'bg-[whitesmoke] flex justify-between p- items-center top-0 fixed w-full '}>

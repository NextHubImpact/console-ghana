          ...
          <div className="mt-14 mb-[6rem] flex flex-wrap  items-center justify-center gap-8">
            {highlightCard.map((val, index) => {
              ...
              return (
                <div
                  key={index}
                  className=" flex flex-col  mb-4 flex-wrap items-center justify-center gap-2 bg-[whitesmoke] text-  border-2   lg:w-[30%] xl:w-[30%] "
                >
                  <img src={img} alt="" />
                  <div className=" flex flex-col items-center gap-2 p-2">
                    <h2 className=" text-wrap text-center font-semibold">
                      {title}
                    </h2>
